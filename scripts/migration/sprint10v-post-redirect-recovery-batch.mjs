...
const DRAFT_PREFIX = "drafts.chamanlawfirm.sprint10v.";
const PUBLIC_PREFIX = "chamanlawfirm-sprint10v-";
const SOURCE_NAME = "legacy-wordpress-backup-2026-06-28-sprint10v";
...
const extractedImageRoot = path.join(process.cwd(), ".tmp", "chaman-sprint10v-images");

const top1000Path = "docs/SPRINT-9M-TOP-1000-LEGACY-BLOG-SELECTION.csv";
const nextConfigPath = "next.config.mjs";
const outDir = "docs/sprint10v";
const selectionCsvPath = "docs/SPRINT-10V-50-BLOG-RECOVERY-SELECTION.csv";
const imageMapPath = "docs/SPRINT-10V-IMAGE-RECOVERY-AND-REFRESH-MAP.csv";
const hiddenReviewPath = "docs/SPRINT-10V-HIDDEN-RISK-CLEANUP.csv";
const resultJsonPath = "docs/sprint10v/sprint10v-restoration-result.json";
...
const titleOverrides = new Map([
  ["lekki-property-when-owner-dies-without-will", "What Happens to Lekki Property When the Owner Dies Without a Will?"],
  ["risk-management-strategies-for-real-estate-investment-in-nigeria", "Risk Management Strategies for Real Estate Investment in Nigeria"],
  [
    "what-is-the-process-for-land-allocation-for-agricultural-purposes-under-the-land-use-act",
    "Land Allocation for Agricultural Purposes Under the Land Use Act"
  ],
  ["can-a-foreigner-buy-property-chaman-law-firm", "Can a Foreigner Buy Property in Nigeria?"],
  ["what-is-the-significan-and-titles-in-nigeria", "What Is the Significance of Land Titles in Nigeria?"],
  ["what-you-need-to-know-when-buying-a-family-g", "What to Know When Buying Family Property in Nigeria"],
  ["force-majeure-clauses-in-business-contracts", "Force Majeure Clauses in Business Contracts in Nigeria"],
  ["evaluating-real-estate-investment-returns", "Evaluating Real Estate Investment Returns in Nigeria"],
...
async function main() {
  ...
  for (const [index, item] of selected.entries()) {
    ...
    selectionRows.push({
      ...
      "current production status": approvedSlugs.has(slug) ? "already public" : "selected for Sprint 10V recovery",
    ...
    imageRows.push({
      ...
      "repeated image risk": "not detected in Sprint 10V recovered image evidence",
...
main().catch((error) => {
  console.error(`Sprint 10V pipeline failed: ${error?.message || String(error)}`);
  process.exit(1);
});
