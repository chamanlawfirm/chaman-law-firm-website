...
const DRAFT_PREFIX = "drafts.chamanlawfirm.sprint10o.";
const PUBLIC_PREFIX = "chamanlawfirm-sprint10o-";
const SOURCE_NAME = "legacy-wordpress-backup-2026-06-28-sprint10o";
...
const extractedImageRoot = path.join(process.cwd(), ".tmp", "chaman-sprint10o-images");

const top1000Path = "docs/SPRINT-9M-TOP-1000-LEGACY-BLOG-SELECTION.csv";
const nextConfigPath = "next.config.mjs";
const outDir = "docs/sprint10o";
const selectionCsvPath = "docs/SPRINT-10O-100-BLOG-RECOVERY-SELECTION.csv";
const imageMapPath = "docs/SPRINT-10O-IMAGE-RECOVERY-AND-REFRESH-MAP.csv";
const hiddenReviewPath = "docs/SPRINT-10O-HIDDEN-RISK-CLEANUP.csv";
const resultJsonPath = "docs/sprint10o/sprint10o-restoration-result.json";
