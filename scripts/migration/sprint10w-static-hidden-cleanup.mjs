...
const DRAFT_PREFIX = "drafts.chamanlawfirm.sprint10w.";
const PUBLIC_PREFIX = "chamanlawfirm-sprint10w-";
const SOURCE_NAME = "legacy-wordpress-backup-2026-06-28-sprint10w";
...
const extractedImageRoot = path.join(process.cwd(), ".tmp", "chaman-sprint10w-images");

const top1000Path = "docs/SPRINT-9M-TOP-1000-LEGACY-BLOG-SELECTION.csv";
const nextConfigPath = "next.config.mjs";
const outDir = "docs/sprint10w";
const selectionCsvPath = "docs/SPRINT-10W-HIDDEN-DRAFT-CLEANUP-SELECTION.csv";
const imageMapPath = "docs/SPRINT-10W-IMAGE-RECOVERY-AND-REFRESH-MAP.csv";
const hiddenReviewPath = "docs/SPRINT-10W-HIDDEN-RISK-CLEANUP.csv";
const resultJsonPath = "docs/sprint10w/sprint10w-restoration-result.json";
const sprint10iResultPath = "docs/sprint10i/sprint10i-restoration-result.json";
const sprint10jResultPath = "docs/sprint10j/sprint10j-restoration-result.json";
const sprint10kResultPath = "docs/sprint10k/sprint10k-restoration-result.json";
const sprint10lResultPath = "docs/sprint10l/sprint10l-restoration-result.json";
const sprint10nResultPath = "docs/sprint10n/sprint10n-restoration-result.json";
const sprint10oResultPath = "docs/sprint10o/sprint10o-restoration-result.json";
const sprint10qResultPath = "docs/sprint10q/sprint10q-restoration-result.json";
const sprint10tResultPath = "docs/sprint10t/sprint10t-approval-result.json";
const sprint10vResultPath = "docs/sprint10v/sprint10v-restoration-result.json";
...
const titleOverrides = new Map([
  ["force-majeure-clauses-in-business-contracts", "Force Majeure Clauses in Business Contracts in Nigeria"],
  ["3-proven-steps-on-how-to-rolve-land-disputes", "How to Resolve Land Disputes in Nigeria"],
  ["land-documentation-excision-vs-gazette", "Land Documentation, Excision and Gazette in Nigeria"],
  ["how-to-draft-a-commercial-contract-a-proven", "How to Draft a Commercial Contract in Nigeria"],
  ["4-main-guide-to-land-ownership-in-nigeria", "Guide to Land Ownership in Nigeria"],
  ["piracy-and-its-burden-on-copyright", "Piracy and Copyright Protection in Nigeria"],
  ["how-to-check-if-a-property-title-is-genuine", "How to Check if a Property Title Is Genuine in Nigeria"],
  ["remedies-for-breach-of-property-contracts-in-lagos-a-legal-guide", "Remedies for Breach of Property Contracts in Lagos"],
  ["insurance-in-construction-contracts", "Insurance in Construction Contracts in Nigeria"],
  ["how-does-land-title-insurance-protect-property-owners-in-nigeria", "How Land Title Insurance Protects Property Owners in Nigeria"],
  ["corporate-tax-obligations-in-nigeria", "Corporate Tax Obligations in Nigeria"],
  ["what-is-the-legal-process-for-land-dispute", "Legal Process for Land Disputes in Nigeria"],
  ["lawyers-help-you-access-inherited-property", "How Probate Lawyers Help Families Access Inherited Property"],
  ["how-does-land-title-regularization-affect-p", "How Land Title Regularization Affects Property Owners"],
  ["the-land-use-act-protect-the-environment", "How the Land Use Act Relates to Environmental Protection"],
  ["immigration-law-at-chaman-law-firm", "Immigration Law Services in Nigeria"],
  ["land-record-keeping-ensure-accurate-land-titles", "Land Record Keeping and Accurate Land Titles in Nigeria"],
  ["5-proven-roles-of-a-child-adoption-lawyer", "Roles of a Child Adoption Lawyer in Nigeria"],
  ["legal-advice-for-expatriates-in-nigeria-ess", "Legal Advice for Expatriates in Nigeria"],
  ["different-types-of-marriage-in-nigeria", "Different Types of Marriage in Nigeria"],
  ["land-titles-in-nigeria", "Land Titles in Nigeria"],
  ["reasons-yourland-title-verification-may-fail", "Reasons Land Title Verification May Fail"],
  ["why-you-need-a-certificate-of-occupancy-in-nigeria", "Why You Need a Certificate of Occupancy in Nigeria"],
  ["what-challenges-are-associated-with-preserving-and-digitizing-historical-land-records", "Challenges in Preserving and Digitizing Historical Land Records"],
  ["real-estate-contracts", "Real Estate Contracts in Nigeria"],
  ["what-is-the-role-of-the-surveyor-general-in-land-allocation-under-the-land-use-act", "Role of the Surveyor-General in Land Allocation Under the Land Use Act"],
  ["what-is-the-legal-way-to-safeguard-your-will", "Legal Ways to Safeguard Your Will in Nigeria"],
  ["top-5-intellectual-property-enforcement-stra", "Intellectual Property Enforcement Strategies in Nigeria"],
  ["why-is-public-awareness-important-for-land-ownership-and-titles-in-nigeria", "Why Public Awareness Matters for Land Ownership and Titles in Nigeria"],
  ["steps-to-understanding-financial-crimes", "Understanding Financial Crimes in Nigeria"],
  [
    "review-of-corporate-affairs-commission-share-capital-for-company-registration-in-nigeria",
    "Corporate Affairs Commission Share Capital Requirements for Company Registration"
  ],
  ["register-your-company-with-cac-in-nigeria", "How to Register Your Company With CAC in Nigeria"],
  ["obtain-a-certificate-of-occupancy-chaman-law", "How to Obtain a Certificate of Occupancy in Nigeria"],
  ["role-of-stamp-duty-in-property-transactions", "Role of Stamp Duty in Property Transactions in Nigeria"],
  ["registration-of-deed-of-assignment-in-nigeria", "Registration of Deed of Assignment in Nigeria"],
  ["can-a-landlord-increase-rent-arbitrarily", "Can a Landlord Increase Rent Arbitrarily in Nigeria?"],
  ["the-basics-of-statutory-right-of-occupancy", "The Basics of Statutory Right of Occupancy in Nigeria"],
  ["family-law-disputes-and-child-abduction", "Family Law Disputes and Child Abduction in Nigeria"],
  ["government-acquired-lands-in-nigeria", "Government-Acquired Lands in Nigeria"],
  ["overview-of-citizenship-in-nigeria", "Overview of Citizenship in Nigeria"],
  ["basic-procedure-for-dissolution-of-marriage", "Basic Procedure for Dissolution of Marriage in Nigeria"],
  ["effect-of-witness-as-beneficiary-in-will", "Effect of a Witness as Beneficiary in a Will in Nigeria"],
  ["what-are-the-implications-of-unregistered-land-titles-in-nigeria", "Implications of Unregistered Land Titles in Nigeria"],
  ["obtaining-a-c-of-o-in-ogun-state", "Obtaining a Certificate of Occupancy in Ogun State"],
  ["legal-aspects-of-employment-contracts", "Legal Aspects of Employment Contracts in Nigeria"],
  [
    "probate-vs-letter-of-administration-in-nigeria-key-differences-you-must-know",
    "Probate vs Letters of Administration in Nigeria"
  ],
  ["how-to-appoint-a-company-secretary-in-nigeria", "How to Appoint a Company Secretary in Nigeria"],
  ["accountability-in-corporate-governance", "Accountability in Corporate Governance in Nigeria"],
  ["business-name-and-a-company-limited-by-shares", "Business Name vs Company Limited by Shares in Nigeria"],
  ["verify-a-property-title-in-lagos", "How to Verify a Property Title in Lagos"],
  ["what-makes-up-a-valid-employment-contract", "What Makes a Valid Employment Contract in Nigeria?"],
  ...
  ["abandonment-and-withdrew-of-court-action", "Abandonment and Withdrawal of Court Actions in Nigeria"],
  ["certificate-of-occupancy-in-rivers-state", "Certificate of Occupancy in Rivers State"],
  ["deal-with-and-bad-tenant-as-a-landlord", "How Landlords Can Handle Difficult Tenants in Nigeria"],
  ["how-do-i-obtain-a-certificate-of-occupancy", "How to Obtain a Certificate of Occupancy in Ogun State"],
  ["how-to-register-a-deed-of-assignment-in-ogun", "How to Register a Deed of Assignment in Ogun State"],
  ["how-to-handle-land-grabbers-in-ogun-state", "How to Handle Land Grabbers in Ogun State"],
  ["how-to-legally-evict-a-tenant-in-lagos-state", "How to Legally Evict a Tenant in Lagos State"],
  ["the-morgage-sell-the-mortgaged-property", "When Can a Mortgagee Sell Mortgaged Property in Nigeria?"],
  ["how-to-obtain-dual-citizenship-in-nigeria-a", "How to Obtain Dual Citizenship in Nigeria"],
  ["legal-remedies-for-breach-of-land-sale-contract", "Legal Remedies for Breach of Land Sale Contract in Nigeria"],
  ["how-to-obtain-an-infant-visa-in-nigeria", "How to Obtain an Infant Visa in Nigeria"],
  ["real-estate-taxes-in-nigeria-transactions", "Real Estate Taxes in Nigerian Property Transactions"],
  ["how-to-apply-for-certificate-of-occupancy-in-nigeria", "How to Apply for Certificate of Occupancy in Nigeria"],
  ["certificate-of-occupancy-in-oyo-state", "Certificate of Occupancy in Oyo State"],
  ["mastering-nigeria-law-for-contract-an-in", "Mastering Contract Law in Nigeria"],
  [
    "how-to-apply-for-and-get-a-certificate-of-occupancy-in-enugu-state-nigeria",
    "How to Apply for Certificate of Occupancy in Enugu State"
  ],
  ["tenancy-law-of-lagos-state-2011", "Tenancy Law of Lagos State 2011"],
  ["recovery-of-premises", "Recovery of Premises in Nigeria"],
  ["how-to-be-a-good-property-lawyer", "What Makes a Good Property Lawyer in Nigeria?"],
  ["what-is-the-cost-of-perfecting-land-titles", "Cost of Perfecting Land Titles in Nigeria"],
  ["deed-of-assignment-guide-to-register", "Guide to Registering a Deed of Assignment in Nigeria"],
  ["proven-steps-on-land-allocation-and-ownership", "Land Allocation and Ownership in Nigeria"],
  ["land-use-act-and-its-role-in-land-allocation", "Land Use Act and Its Role in Land Allocation"],
  ["how-do-i-draft-tenancy-agreement-in-lagos", "How to Draft a Tenancy Agreement in Lagos"],
  ["company-management-in-nigeria", "Company Management in Nigeria"],
  ["legalimplicationsof-co-ownership-of-property", "Legal Implications of Co-Ownership of Property in Nigeria"],
  ["lagos-inheritance-law-explained-family-rights", "Lagos Inheritance Law and Family Property Rights"],
  ["roles-of-a-property-lawyer-in-real-estate", "Roles of a Property Lawyer in Real Estate Transactions"],
  ["how-tohandle-land-disputes-withfamilymembers", "How to Handle Land Disputes With Family Members"],
  ["what-is-the-cost-of-perfecting-land-title", "Cost of Perfecting a Land Title in Nigeria"],
  ["letters-of-administration-in-lagos-state", "Letters of Administration in Lagos State"],
  ["procedure-for-company-registration-in-nigeria", "Procedure for Company Registration in Nigeria"],
  ["a-complete-guide-on-how-to-register-a-company-in-nigeria", "Complete Guide to Registering a Company in Nigeria"],
  [
    "how-to-apply-for-certificate-of-occupancy-in-lagos-state-nigeria",
    "How to Apply for Certificate of Occupancy in Lagos State"
  ],
  ["taxation-vat-and-other-indirect-taxes-in-nigeria", "VAT and Other Indirect Taxes in Nigeria"],
  ["transfer-land-ownership-and-land-document", "Transfer of Land Ownership and Land Documents in Nigeria"],
  ["navigating-the-probate-registry-in-ogun-state", "Navigating the Probate Registry in Ogun State"],
  ["how-to-verify-property-titles-in-nigeria", "How to Verify Property Titles in Nigeria"],
  ["division-in-divorce-proceedings", "Division of Property in Divorce Proceedings in Nigeria"],
  ["calculate-land-use-charge-chaman-law-firm", "How to Calculate Land Use Charge in Nigeria"],
  ["strategies-to-handle-a-bad-tenant-legally", "Legal Strategies for Handling Difficult Tenants in Nigeria"],
  ["verify-land-titles-before-buying-property", "How to Verify Land Titles Before Buying Property"],
  ["business-registration-process-in-lagosa-com", "Business Registration Process in Lagos"],
  ["difference-between-excision-gazette-c-of-o", "Difference Between Excision, Gazette and Certificate of Occupancy"],
  ["9-cyber-crime-prosecution-breakthrough-ch", "Cybercrime Prosecution in Nigeria"],
  ["how-to-perfect-a-property-title-in-nigeria", "How to Perfect a Property Title in Nigeria"],
  ["criteria-for-patent-in-nigeria", "Criteria for Patent Protection in Nigeria"],
  ["what-are-the-penalties-for-fake-land-documents", "Penalties for Fake Land Documents in Nigeria"],
  ["estate-administration-in-lagos-state", "Estate Administration in Lagos State"],
  ["mechanisms-for-the-childs-rights-act", "Mechanisms Under the Child Rights Act in Nigeria"],
  ["drafting-company-bylaws-in-nigeria-a-compre", "Drafting Company Bylaws in Nigeria"],
  ["the-essential-ethics-of-debt-recovery", "Ethical Debt Recovery in Nigeria"],
  [
    "4-proven-features-of-customary-marriage-and-the-bill-of-rights-conflicting-interests",
    "Customary Marriage and Constitutional Rights in Nigeria"
  ],
  ["how-to-register-a-tech-company-in-nigeria", "How to Register a Tech Company in Nigeria"],
  ["understanding-the-land-use-act-in-nigeria", "Understanding the Land Use Act in Nigeria"],
  ["modernizing-customary-marriage", "Modernizing Customary Marriage in Nigeria"],
  ["priority-in-entitlement", "Priority in Estate Entitlement Under Nigerian Succession Law"],
  [
    "how-does-the-land-use-act-interact-with-the-petroleum-industry",
    "How the Land Use Act Interacts With the Petroleum Industry"
  ],
  ["legal-bonds-of-marriage-in-nigeria", "Legal Bonds of Marriage in Nigeria"],
  ["is-a-woman-a-property-to-be-inherited", "Can a Woman Be Treated as Property Under Nigerian Inheritance Law?"],
  ["why-a-certificate-of-occupancy-c-of-o-is", "Why a Certificate of Occupancy Matters in Nigeria"],
  ["legal-research-for-nigerian-litigation-cases", "Legal Research for Nigerian Litigation Cases"],
  ["how-is-land-registry-practice-in-nigeria", "Land Registry Practice in Nigeria"],
  ["effect-of-not-paying-child-support", "Effect of Not Paying Child Support in Nigeria"],
  ["role-of-community-leaders-in-land-allocation", "Role of Community Leaders in Land Allocation"],
  ["lagos-property-succession-without-a-will", "Lagos Property Succession Without a Will"],
  ["foreign-wills-and-lagos-property-what-to-know", "Foreign Wills and Lagos Property: What to Know"],
  ["police-prosecution-in-nigerian-courts", "Police Prosecution in Nigerian Courts"],
  ["what-are-the-legal-rights-of-private-property-owners", "Legal Rights of Private Property Owners in Nigeria"],
  ["use-arbitration-for-property-disputes-lagos", "Using Arbitration for Property Disputes in Lagos"],
  ["how-to-acquire-citizenship-in-nigeria", "How to Acquire Citizenship in Nigeria"],
  ["types-of-wills", "Types of Wills in Nigeria"],
  ["what-is-trespass-to-land2", "What Is Trespass to Land in Nigeria?"],
  ["lawful-methods-to-recover-debt-in-nigeria", "Lawful Methods to Recover Debt in Nigeria"],
  ["how-to-handle-land-grabbers-in-lagos", "How to Handle Land Grabbers in Lagos"],
  ["land-dispute-resolution-in-nigeria-court-system", "Land Dispute Resolution in the Nigerian Court System"],
  ["taxes-exemptions-and-incentives-in-nigeria", "Tax Exemptions and Incentives in Nigeria"],
  ["the-legal-implications-of-breach-of-contract", "Legal Implications of Breach of Contract in Nigeria"],
  ["legal-processes-of-transferring-property", "Legal Process for Transferring Property in Nigeria"],
  ["tax-planning-and-avoidance-in-nigeria", "Tax Planning and Tax Avoidance in Nigeria"],
  ["verify-land-ownership-with-the-lagos-state", "How to Verify Land Ownership With Lagos State Records"],
  ["probate-for-a-deceased-estate-in-nigeria", "Probate for a Deceased Estate in Nigeria"],
  ["legally-challenge-forged-land-documents-in-ogun", "How to Challenge Forged Land Documents in Ogun State"],
  ["how-can-nigerians-in-the-diaspora-buy-property", "How Nigerians in the Diaspora Can Buy Property Safely"],
  [
    "lagos-property-succession-how-to-transfer-ownership-after-a-death",
    "Lagos Property Succession: How to Transfer Ownership After Death"
  ],
  ["legal-requirements-for-land-purchase", "Legal Requirements for Land Purchase in Nigeria"],
  ["procedures-for-making-a-will-in-nigeria", "Procedures for Making a Will in Nigeria"],
  ["legal-steps-to-perfecting-title-documents", "Legal Steps to Perfecting Title Documents in Nigeria"],
  ["how-does-the-land-use-act-affect-land-title", "How the Land Use Act Affects Land Title in Nigeria"],
  ["legal-remedies-for-breach-of-contract", "Legal Remedies for Breach of Contract in Nigeria"],
  ["when-a-loved-one-dies-without-a-will", "What Happens When a Loved One Dies Without a Will in Nigeria"],
  ["contract-of-sale-of-land-and-what-it-takes", "Contract of Sale of Land in Nigeria"],
  ["acquire-and-secure-industrial-land-in-ogun", "How to Acquire and Secure Industrial Land in Ogun State"],
  ["8-steps-to-enforce-court-judgments-innigeria", "Steps to Enforce Court Judgments in Nigeria"],
  ["roles-of-a-cybercrime-lawyer-in-nigeria", "Roles of a Cybercrime Lawyer in Nigeria"],
  ["effects-of-exchange-of-contract", "Effects of Exchange of Contract in Property Transactions"],
  ["floodplain-management-under-the-land-use-act", "Floodplain Management Under the Land Use Act in Nigeria"],
  ["what-is-the-cost-of-perfecting-land-titles-2", "Cost of Perfecting Land Titles in Nigeria"],
  ["what-is-the-process-of-obtaining-a-c-of-o", "Process of Obtaining a Certificate of Occupancy in Nigeria"],
  ["difference-between-c-of-o-and-governors-consent", "Difference Between C of O and Governor's Consent"],
  ["cyber-crime-investigation-techniques", "Cybercrime Investigation Techniques in Nigeria"],
  ["family-law-issues-for-expatriate-families", "Family Law Issues for Expatriate Families in Nigeria"],
  ["the-role-of-town-planners-in-land-allocation-under-the-land-use-act", "Role of Town Planners in Land Allocation Under the Land Use Act"],
  ["ways-to-resolve-property-disputes-in-ogun", "Ways to Resolve Property Disputes in Ogun State"],
  ["8-step-business-registration-process-in-lag", "Business Registration Process in Lagos"],
  ["legal-pitfalls-in-debt-recovery", "Legal Pitfalls in Debt Recovery in Nigeria"],
  ["proven-steps-how-to-file-patent-in-nigeria", "How to File a Patent in Nigeria"],
  ["debt-recovery-in-banking-sector", "Debt Recovery in the Banking Sector in Nigeria"],
  ["legal-aspects-of-commercial-litigation", "Legal Aspects of Commercial Litigation in Nigeria"],
  ["proven-steps-on-capacity-to-make-a-will", "Capacity to Make a Will in Nigeria"],
  ["landlord-and-tenant-relationship-on-property", "Landlord and Tenant Relationship in Property Law"],
  ["the-process-of-transferring-land-in-nigeria", "Process of Transferring Land in Nigeria"],
  ["4-proven-cross-border-cybercrime-issues", "Cross-Border Cybercrime Issues in Nigeria"],
  ["contractual-dispute-resolution", "Contractual Dispute Resolution in Nigeria"],
  ["the-land-use-act-relate-to-land-conflicts", "How the Land Use Act Relates to Land Conflicts"],
  ["mastering-nigerian-company-law-essentialstep", "Essential Steps in Nigerian Company Law"],
  ["how-does-the-land-use-act-influence-real-estate-development", "How the Land Use Act Influences Real Estate Development"],
  ["company-registration-in-nigeria", "Company Registration in Nigeria"],
  ["land-tenure-systems-coexist-with-statutory-land", "How Land Tenure Systems Coexist With Statutory Land Ownership"],
  ["the-cyber-crime-investigation-procedure", "Cybercrime Investigation Procedure in Nigeria"],
  ["aim-to-improve-land-titles-and-ownership", "Reforms to Improve Land Titles and Ownership in Nigeria"],
  ["investigating-title-in-property-transaction", "Investigating Title in Property Transactions"],
  ["challenging-forged-property-documents-in-lagos", "Challenging Forged Property Documents in Lagos"],
  [
    "how-can-issues-of-land-fraud-and-illegal-land-transactions-be-addressed-in-nigeria",
    "Addressing Land Fraud and Illegal Land Transactions in Nigeria"
  ],
  ["how-to-register-a-company-in-nigeria-2024", "How to Register a Company in Nigeria"],
  ["duties-of-company-board-of-directors", "Duties of Company Board Directors in Nigeria"],
  ["compliance-with-debt-recovery-regulations", "Compliance With Debt Recovery Regulations in Nigeria"],
  ["due-diligence-in-real-estate-transaction", "Due Diligence in Real Estate Transactions"],
  ["the-role-of-lawyers-in-debt-recovery-5-keys", "Role of Lawyers in Debt Recovery in Nigeria"],
  ["intellectual-property-in-franchise-operations", "Intellectual Property in Franchise Operations"],
  ["disputes-arising-from-property-ownership", "Disputes Arising From Property Ownership in Nigeria"],
  ["corporate-fraud-and-mismanagement", "Corporate Fraud and Mismanagement in Nigeria"],
  ["legal-assistance-for-visa-appeals-5-step", "Legal Assistance for Visa Appeals in Nigeria"],
  ["thing-you-need-to-know-about-a-legal-will", "What to Know About a Legal Will in Nigeria"],
  ["challenges-women-face-in-obtaining-land-titles", "Challenges Women Face in Obtaining Land Titles in Nigeria"],
  ["digitization-impact-land-title-registration", "Impact of Digitization on Land Title Registration"],
  ["legally-binding-contracts", "Legally Binding Contracts in Nigeria"]
]);

const metaDescriptionOverrides = new Map([
  [
    "force-majeure-clauses-in-business-contracts",
    "Understand force majeure clauses in Nigerian business contracts, including risk allocation, performance delays, documentation, and when to seek legal advice."
  ],
  [
    "3-proven-steps-on-how-to-rolve-land-disputes",
    "Learn practical, lawful steps for resolving land disputes in Nigeria, including document review, negotiation, evidence preservation, and legal consultation."
  ],
  [
    "land-documentation-excision-vs-gazette",
    "Understand key land documentation terms in Nigeria, including excision, gazette, title review, due diligence, and why legal verification matters."
  ]
]);
...
async function withRetry(label, operation, attempts = 4) {
  ...
  for (let attempt = 1; attempt <= attempts; attempt += 1) {
    try {
      ...
      const retryable = /ECONNRESET|ETIMEDOUT|EAI_AGAIN|ENOTFOUND|socket|network|timeout|fetch failed/i.test(message);

      if (!retryable || attempt === attempts) {
        throw new Error(`${label}: ${message}`);
      }

      console.warn(`Retrying ${label} after network error (${attempt}/${attempts}): ${message}`);
...
function buildDoc(row, post, rank, wpData, imageAssetId = "", imageAlt = "") {
  ...
  const seoDescription =
    metaDescriptionOverrides.get(slug) ||
    rewriteSeoTemplate(rank?.seo_description || meta.rank_math_description || row["old meta description"] || row["meta description"] || excerpt, title);
  const keywords = [
...
async function ensureSelectedImagesExtracted(entries) {
  ...
  try {
    await execFileAsync("tar", ["-xf", tarGzPath, "-C", extractedImageRoot, ...missing], { maxBuffer: 10 * 1024 * 1024 });
  } catch {
    for (const entry of missing) {
      try {
        await execFileAsync("tar", ["-xf", tarGzPath, "-C", extractedImageRoot, entry], { maxBuffer: 1024 * 1024 });
      } catch {
        console.warn(`Image archive entry unavailable; leaving draft image unset: ${entry}`);
      }
    }
  }
}
...
async function ensureImageAsset(client, row) {
  ...
  const existing = await withRetry(
    `find image asset ${row.imageEntry}`,
    () =>
      client.fetch('*[_type == "sanity.imageAsset" && source.id == $sourceId][0]{_id}', {
        sourceName: SOURCE_NAME,
        sourceId: row.imageEntry
      })
  );
  ...
  try {
    asset = await withRetry(
      `upload image asset ${row.imageEntry}`,
      () =>
    ...
    const message = error?.message || String(error);
    if (/permission .*create|Insufficient permissions/i.test(message)) {
      return { assetId: "", status: "asset_upload_permission_missing" };
    }
    throw error;
  }
...
async function ensureDocument(client, doc, label) {
  const existing = await withRetry(`check ${label} ${doc._id}`, () => client.fetch("*[_id == $id][0]._id", { id: doc._id }));
  if (existing) return { status: "existing_document_reused" };

  try {
    await withRetry(`create ${label} ${doc._id}`, () => client.create(doc));
  } catch (error) {
    const message = error?.message || String(error);
    if (/already exists/i.test(message)) return { status: "existing_document_reused" };
    throw error;
  }
...
async function sanityState(client) {
  const [approved, hiddenDrafts] = await Promise.all([
    withRetry("fetch approved posts", () =>
    ...
    withRetry("fetch hidden drafts", () =>
      client.fetch(`*[_type == "post" && lawFirmApproved != true && (
      _id in path("drafts.chamanlawfirm.sprint10i.*") ||
      _id in path("drafts.chamanlawfirm.sprint10j.*") ||
      _id in path("drafts.chamanlawfirm.sprint10k.*") ||
      _id in path("drafts.chamanlawfirm.sprint10l.*") ||
      _id in path("drafts.chamanlawfirm.sprint10n.*") ||
      _id in path("drafts.chamanlawfirm.sprint10o.*") ||
      _id in path("drafts.chamanlawfirm.sprint10q.*") ||
      _id in path("drafts.chamanlawfirm.sprint10t.*") ||
      _id in path("drafts.chamanlawfirm.sprint10v.*") ||
      _id in path("drafts.chamanlawfirm.sprint10w.*")
...
async function main() {
  ...
  const [
    ...
    fsp.readFile(sprint10jResultPath, "utf8").catch(() => "{}"),
    fsp.readFile(sprint10kResultPath, "utf8").catch(() => "{}"),
    fsp.readFile(sprint10lResultPath, "utf8").catch(() => "{}"),
    fsp.readFile(sprint10nResultPath, "utf8").catch(() => "{}"),
    fsp.readFile(sprint10oResultPath, "utf8").catch(() => "{}"),
    fsp.readFile(sprint10qResultPath, "utf8").catch(() => "{}"),
    fsp.readFile(sprint10tResultPath, "utf8").catch(() => "{}"),
    fsp.readFile(sprint10vResultPath, "utf8").catch(() => "{}")
  ]);
  ...
  const previousKeptHiddenSlugs = new Set(
    [
      ...(JSON.parse(sprint10iResultText).keptHidden || []),
      ...(JSON.parse(sprint10jResultText).keptHidden || []),
      ...(JSON.parse(sprint10kResultText).keptHidden || []),
      ...(JSON.parse(sprint10lResultText).keptHidden || []),
      ...(JSON.parse(sprint10nResultText).keptHidden || []),
      ...(JSON.parse(sprint10oResultText).keptHidden || []),
      ...(JSON.parse(sprint10qResultText).keptHidden || []),
      ...(JSON.parse(sprint10tResultText).keptHidden || []),
      ...(JSON.parse(sprint10vResultText).keptHidden || [])
    ]
      .map((item) => item.slug)
      .filter(Boolean)
  );
  const previousHiddenDrafts = state.hiddenDrafts.filter((doc) => doc.slug && previousKeptHiddenSlugs.has(doc.slug));
  const previousHiddenSlugs = new Set(previousHiddenDrafts.map((doc) => doc.slug).filter(Boolean));

  const hiddenReviewRows = reviewHiddenDrafts(previousHiddenDrafts, redirectMap);
  await fsp.writeFile(
    hiddenReviewPath,
  ...
  const rawCandidates = topRows
    ...
    .filter((row) => !previousHiddenSlugs.has(row["old slug"]) || controlledApprovalSlugs.includes(row["old slug"]))
    .slice(0, 500)
    .map((row) => ({
      ...row,
  ...
  const draftSlugSet = new Set(draftItems.map((item) => item.row["old slug"]));
  if (shouldApply) {
    const entriesToExtract = draftItems
      .filter((item) => controlledApprovalSlugs.includes(item.row["old slug"]))
      .map((item) => item.imageInfo.selectedEntry)
      .filter(Boolean);
    await ensureSelectedImagesExtracted(entriesToExtract);
    await ensureDocument(client, { _id: AUTHOR_ID, _type: "author", name: AUTHOR_NAME, slug: { _type: "slug", current: "charles-chukwuma-nkwoka" } }, "author");
  }
  ...
  for (const [index, item] of selected.entries()) {
    ...
    const slug = row["old slug"];
    const inDraftBatch = draftSlugSet.has(slug);
    const inControlledApproval = controlledApprovalSlugs.includes(slug);
    ...
    if (shouldApply && inDraftBatch && inControlledApproval && imageInfo.selectedEntry) {
    ...
    if (inDraftBatch) docs.push({ built, row, post, imageInfo, imageAlt, assetResult, readyForApproval, review });
    ...
    selectionRows.push({
      ...
      "current production status": approvedSlugs.has(slug) ? "already public" : "selected for Sprint 10W recovery",
    ...
    imageRows.push({
      ...
      "image uploaded to Sanity yes/no": assetResult?.assetId ? "yes" : shouldApply && inDraftBatch ? "no" : "pending apply",
      "Sanity image asset reference": assetResult?.assetId || "",
      "alt text": imageAlt,
      "fallback used yes/no": "no",
      "repeated image risk": "not detected in Sprint 10W recovered image evidence",
      "old repeated image refreshed yes/no": "no",
  ...
  if (shouldApply) {
    ...
    for (const category of categories.values()) await ensureDocument(client, category, "category");

    for (const item of docs) {
      const draftDoc = { ...item.built.doc, lawFirmApproved: false };
      await ensureDocument(client, draftDoc, "draft");
    }
    ...
    for (const item of approvedThisRun) {
      ...
      await ensureDocument(client, publicDoc, "public post");
    }
  }
  ...
  await fsp.writeFile(
    ...
    `${writeCsv(imageRows, [
      ...
      "repeated image risk",
      "old repeated image refreshed yes/no",
      "notes"
    ])}\n`,
    "utf8"
  );
...
main().catch((error) => {
  console.error(`Sprint 10W pipeline failed: ${error?.message || String(error)}`);
  process.exit(1);
});
