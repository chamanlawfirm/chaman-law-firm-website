...
export async function generateStaticParams() { return getPublishedContentSlugs("podcasts"); }

export async function generateMetadata({ params }: PageProps): Promise<Metadata> {
  const item = await getPublishedContentBySlug("podcasts", (await params).slug);
