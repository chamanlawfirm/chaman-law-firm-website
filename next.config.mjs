...
const deepLegacy404Redirects = [
  ...
  { source: "/obtaining-a-c-of-o-in-ogun-state", destination: "/resources/blog/how-do-i-obtain-a-certificate-of-occupancy" },
  { source: "/legal-aspects-of-employment-contracts", destination: "/practice-areas/employment-law/employment-contract-review" },
  { source: "/probate-vs-letter-of-administration-in-nigeria-key-differences-you-must-know", destination: "/practice-areas/probate-estate-administration/probate-in-lagos-everything-you-need-to-know" },
  ...
  { source: "/what-are-the-requirements-for-compulsory-acquisition-of-land-in-nigeria", destination: "/resources/blog/what-are-the-requirements-for-compulsory-acquisition-of-land-in-nigeria" },
  { source: "/land-documentation-excision-vs-gazette", destination: "/resources/blog/land-documentation-excision-vs-gazette" },
  { source: "/legally-terminate-shipping-contract-in-nigeria", destination: "/practice-areas/corporate-commercial-law/contract-drafting-review" },
  { source: "/accountability-in-corporate-governance", destination: "/practice-areas/corporate-commercial-law/corporate-governance" },
  { source: "/business-name-and-a-company-limited-by-shares", destination: "/practice-areas/corporate-commercial-law/business-name-registration-advisory" },
  { source: "/verify-a-property-title-in-lagos", destination: "/practice-areas/property-real-estate-law/property-verification" },
  { source: "/what-makes-up-a-valid-employment-contract", destination: "/practice-areas/employment-law/employment-contract-review" },
...
const sprint11oStaticAuthorityRedirects = [
  ...
  { source: "/land-registration-system-in-nigeria", destination: "/resources/blog/land-registration-system-in-nigeria" },
  { source: "/landlords-and-tenants-in-nigeria", destination: "/resources/blog/landlords-and-tenants-in-nigeria" },
  { source: "/of-the-securities-and-exchange-commission", destination: "/practice-areas/corporate-commercial-law/securities-regulatory-compliance" },
  { source: "/enforcing-fundamental-human-right", destination: "/practice-areas/litigation-dispute-resolution/fundamental-rights-enforcement" },
  { source: "/probate-in-lagos-everything-you-need-to-know", destination: "/practice-areas/probate-estate-administration/probate-in-lagos-everything-you-need-to-know" },
  { source: "/board-of-directors-in-nigerian-companies", destination: "/practice-areas/corporate-commercial-law/board-governance" },
  { source: "/challenges-of-implementing-the-land-use-act", destination: "/practice-areas/property-real-estate-law/land-use-act-advisory" },
  { source: "/rights-of-parties-to-a-mortgage", destination: "/practice-areas/property-real-estate-law/mortgage-document-review" },
  { source: "/methods-of-transfer-of-shares", destination: "/practice-areas/corporate-commercial-law/share-transfer" },
  { source: "/can-a-member-be-expelled-from-a-trade-union", destination: "/practice-areas/employment-law/trade-union-membership-disputes" },
  { source: "/expert-witnesses-in-nigeria-court-proceeding", destination: "/practice-areas/litigation-dispute-resolution/expert-witnesses" },
  { source: "/how-to-calculate-and-pay-land-use-charge", destination: "/resources/blog/how-to-calculate-and-pay-land-use-charge" },
...
const sprint12fLegacyRedirects = [
  ...
  { source: "/how-to-legally-evict-a-tenant-in-lagos-state", destination: "/resources/blog/how-to-legally-evict-a-tenant-in-lagos-state" },
  ...
  { source: "/right-of-an-illegitimate-child", destination: "/resources/blog/right-of-an-illegitimate-child" },
  { source: "/limitation-of-action-in-nigeria", destination: "/resources/blog/limitation-of-action-in-nigeria" },
  ...
  { source: "/what-makes-a-valid-employment-contract-in-nigeria", destination: "/resources/blog/what-makes-a-valid-employment-contract-in-nigeria" },
  { source: "/accountability-in-corporate-governance-in-nigeria", destination: "/resources/blog/accountability-in-corporate-governance-in-nigeria" },
